...
class ListViewAtleta : AppCompatActivity() {
    ...
    private fun cargarProductos(){
        val listView = findViewById<ListView>(R.id.lv_producto)
        FirestoreAtleta.consultarProductos {
            if (it!= null) {
    ...
    override fun onCreateContextMenu(
        ...
        FirestoreAtleta.consultarProductos { idProducto = it[posicion].id }
    }
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        return when (item.itemId){
            R.id.mn_editar_prod ->{
                ...
                irActividad(EditarAtleta::class.java)
                return true
            }
            ...
            R.id.mn_ver_resenias -> {
                mostrarSnackbar("${posicionItem}")
                irActividad(ListViewDeporte::class.java)
                return true
            }
    ...
    fun agregarProducto() {
        irActividad(CrearAtleta:: class.java)
        cargarProductos()
    }
    ...
    fun eliminarProducto (){
        ...
        FirestoreAtleta.eliminarProducto(idProducto)
        cargarProductos()
    }
