...
class EditarDeporte : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirestoreDeporte.consultarResenia(idResenia!!){
            id.setText(it.id)
    ...
    private fun editarResenia() {
        ...
        FirestoreDeporte.actualizarResenia(deporteEditada)
